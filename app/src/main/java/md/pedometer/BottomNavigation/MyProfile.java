...
import md.pedometer.Components.SensorListener;
import md.pedometer.Database.Database;
import md.pedometer.Database.DatabaseHandler;
import md.pedometer.R;
import md.pedometer.util.API23Wrapper;
...
public class MyProfile extends Fragment implements AdapterView.OnItemSelectedListener {
    ...
    private void loadSpinnerData() {
        ...
        ArrayAdapter<String> dataadapter = new ArrayAdapter<>(this.getActivity(),android.R.layout.simple_spinner_dropdown_item,labels);
